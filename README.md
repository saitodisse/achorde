...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [`musical-domain`](./packages/musical-domain)               | [`@achorde/musical-domain`](https://www.npmjs.com/package/@achorde/musical-domain)               | [docs](https://achorde-musical-domain.vercel.app/en/packages/musical-domain)                                  | [demo](https://achorde-musical-domain.vercel.app/) · [storybook](https://storybook-musical-domain.vercel.app/) |
